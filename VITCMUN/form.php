    ...
    <div class="main-content" align="left">
        <form class="form-labels-on-top" method="POST" action="submitted.php">
		  ...
		  <input type="radio" name="ans_1WHSR" value="Agenda 3WHSW">Agenda 3WHSW<br>
			...
			<div align="left">
			<b><h4>Select your Agenda</h4></b><br>
			<input type="radio" name="ans_1IP" value="Agenda 1IP" checked>Agenda 1IP<br>
			<input type="radio" name="ans_1IP" value="Agenda 2IP">Agenda 2IP<br>
			<input type="radio" name="ans_1IP" value="Agenda 3IP">Agenda 3IP<br>
			<br>
			</div>
